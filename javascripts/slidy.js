...
function addToolbar()
{
   ...
   if (ns_pos) // a reasonably behaved browser
   {
      ...
      left.setAttribute("class", "toolbar-left");

      // global end of slide indicator
      eos = document.createElement("span");
	  eos.setAttribute("id", "eos")
      eos.innerHTML = "* ";
      ...
      logo.innerHTML = "";
	  logo.setAttribute("id", "toolbar-logo")
...
//    start.innerHTML = "print!".localize();
      ...
      slideCounter = document.createElement("div");
	  slideCounter.setAttribute("id", "slide-counter");
	  ...
	  slideCounter.style.fontsize = "2em";
